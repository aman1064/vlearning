...
public class ChRoomServlet extends HttpServlet{
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		if(s != null && s.equals("true")){
            ...
            printwriter.println("<center><input type=submit value='Exit from Class Room' class=smalltext>");
    ...
    private void writeMessage(PrintWriter printwriter, ChatRooms  chatroom, String s){
        ...
        printwriter.println("<body marginheight=0 marginwidth=0>");
	printwriter.println("<table align=center bgcolor='#009966' width=100% height=100%>");
	printwriter.println("<tr><td valign=top>");
        printwriter.println("Class-Room Name: " + chatroom.getName() + "<br>You are: " + s + "<br><br><br>");
        if(chatroom.size() == 0){
